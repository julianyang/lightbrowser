...
class BrowserWebStorageNamespace::NamespaceImpl : public WebStorageNamespace {
public:
    explicit NamespaceImpl(const base::WeakPtr<BrowserWebStorageNamespace>& parent);
    NamespaceImpl(const base::WeakPtr<BrowserWebStorageNamespace>& parent,
...
private:
    ...
    base::WeakPtr<BrowserWebStorageNamespace> parent_;
    int namespace_id_;
};

class BrowserWebStorageNamespace::AreaImpl : public WebStorageArea {
public:
    AreaImpl(const base::WeakPtr<BrowserWebStorageNamespace>& parent,
...
BrowserWebStorageNamespace::NamespaceImpl::NamespaceImpl(
    const base::WeakPtr<BrowserWebStorageNamespace>& parent)
    : parent_(parent),
...
WebStorageArea* BrowserWebStorageNamespace::NamespaceImpl::createStorageArea(
    const WebString& origin) 
{
        return new AreaImpl(parent_, namespace_id_, GURL(origin));
}

WebStorageNamespace* BrowserWebStorageNamespace::NamespaceImpl::copy()
{
...
bool BrowserWebStorageNamespace::NamespaceImpl::isSameNamespace(
...
BrowserWebStorageNamespace::AreaImpl::AreaImpl(
    const base::WeakPtr<BrowserWebStorageNamespace>& parent,
    int namespace_id, const GURL& origin)
    : parent_(parent),
    connection_id_(0) 
...
unsigned BrowserWebStorageNamespace::AreaImpl::length()
{
    if (Host())
...
WebString BrowserWebStorageNamespace::AreaImpl::key(unsigned index)
{
    if (Host())
...
WebString BrowserWebStorageNamespace::AreaImpl::getItem(const WebString& key)
{
    if (Host())
...
void BrowserWebStorageNamespace::AreaImpl::setItem(
...
void BrowserWebStorageNamespace::AreaImpl::removeItem(
...
void BrowserWebStorageNamespace::AreaImpl::clear(const WebURL& pageUrl) 
{
    if (!Host())
        return;
...
BrowserWebStorageNamespace* BrowserWebStorageNamespace::g_instance_;

BrowserWebStorageNamespace::BrowserWebStorageNamespace()
    : weak_factory_(this),
...
WebStorageNamespace* BrowserWebStorageNamespace::CreateLocalStorageNamespace()
{
    return new NamespaceImpl(weak_factory_.GetWeakPtr());
}

WebStorageNamespace* BrowserWebStorageNamespace::CreateSessionStorageNamespace()
{
...
void BrowserWebStorageNamespace::OnDomStorageItemSet(
...
void BrowserWebStorageNamespace::OnDomStorageItemRemoved(
    const dom_storage::DomStorageArea* area,
    const string16& key,
...
void BrowserWebStorageNamespace::OnDomStorageAreaCleared(
    const dom_storage::DomStorageArea* area,
    const GURL& page_url) 
{
    DispatchDomStorageEvent(area, page_url,
...
void BrowserWebStorageNamespace::DispatchDomStorageEvent(
    const dom_storage::DomStorageArea* area,
    const GURL& page_url,
    ...
    const NullableString16& old_value)
{
    ...
    if (area->namespace_id() == dom_storage::kLocalStorageNamespaceId) {
        ...
        NamespaceImpl session_namespace_for_event_dispatch(
            base::WeakPtr<BrowserWebStorageNamespace>(), area->namespace_id());
